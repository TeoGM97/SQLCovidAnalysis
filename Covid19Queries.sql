...
From 
	Covid19Project..CovidDeaths
Where continent is not null --Select only countries
Group by location
...
From 
	Covid19Project..CovidDeaths
Where continent is null --Select only Continents and macro locations
Group by location
Order by total_death_count desc
...
Select *
From 
	Covid19Project..CovidDeaths dea
